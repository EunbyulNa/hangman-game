const words = ["mango", "lemon", "pineapple", "apple", "banana", "kewi", "strawberries", "grape", "orange", "watermelon", "cherry", "papaya","cranberry", "peach", "lychee", "pear", "blueberry"];
  ...
  //Keydown 
      window.addEventListener("keydown", function(e) {
        ...
        //and fill the correct word into the each span
          ...
          wrongContainer.innerHTML = wrongGuessArr;
          lives --;
          drawHangman()
        }
       }
